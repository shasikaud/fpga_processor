...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" NUMWORDS_A=512 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" POWER_UP_UNINITIALIZED="FALSE" RAM_BLOCK_TYPE="M9K" read_during_write_mode_port_a="OLD_DATA" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=9 address_a clock0 data_a q_a rden_a wren_a
...
endmodule //memory_ip_altsyncram
//VALID FILE
...
`endif
	...
	memory_ip_altsyncram	memory_ip_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.rden_a (rden),
